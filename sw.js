const CACHE='jeongbo-cbt-20260821j';
const FILES=['./','./index.html','./privacy.html','./app.css','./app.js','./logic.js','./concept-engine.js','./option-explainer.js','./drive-sync.js','./manifest.webmanifest'];
